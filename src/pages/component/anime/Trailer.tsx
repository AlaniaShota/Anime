...
export const Trailer = ({ video }) => {
  function notFoundData() {
    return (
      <div className="flex flex-col w-full my-4 justify-start items-start text-white">
        <div className="flex flex-col w-full my-8 justify-start items-start">
          <h1 className=" font-extralight text-2xl mb-2">Trailer</h1>
          <div className="w-full h-96 bg-black/55 flex justify-center items-center gap-2 opacity-65">
